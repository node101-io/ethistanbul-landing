        ...
        items: [
            {
                ...
                answer: "Anyone passionate about blockchain is welcome to join the ETHIstanbul Conference! Whether you're a developer, designer, or simply curious about Ethereum, we welcome your applications. No previous experience? No problem; the conference has been designed with flows suitable for all levels. The ETHIstanbul Hackathon is open to hackers of all skill levels! Don't worry if you're new to blockchain; you'll find plenty of support from mentors and other hackers.",
            },
            {
                question: "How can I apply to participate?",
                answer: "Get your conference ticket here and apply for a hackathon here. We review applications regularly, so be sure to apply early to increase your chances of acceptance. The ETHIstanbul Conference will take place on Friday, September 5th, hosting over 800 participants. On Saturday and Sunday, September 6th and 7th, we'll bring together hundreds of developers for the ETHIstanbul Hackathon. Hurry up and get your conference ticket here and apply for the hackathon here. See you soon.",
            },
            {
